...
print( subprocess.check_output(['sed', '-i','.tmp', 's@__CASUAL_DOMAIN_HOME__@' + os.getenv("CASUAL_DOMAIN_HOME") +'@g', os.getenv("CASUAL_BUILD_HOME") + '/../thirdparty/nginx/nginx.conf']))
os.rename(os.getenv("CASUAL_BUILD_HOME") + '/../thirdparty/nginx/nginx.conf', prefix + '/conf/nginx.conf')
os.rename(os.getenv("CASUAL_BUILD_HOME") + '/../thirdparty/nginx/nginx.conf.tmp', os.getenv("CASUAL_BUILD_HOME") + '/../thirdparty/nginx/nginx.conf') 
print("Done")
