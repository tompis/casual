                  ...
                  namespace configuration
                  {
                     struct Model
                     {
                        struct Entry 
                        {
                           ...
                           {
                              CASUAL_SERIALIZE( CASUAL_MAKE_NVP( service));
                              CASUAL_SERIALIZE( CASUAL_MAKE_NVP( type));
                              CASUAL_SERIALIZE( CASUAL_MAKE_NVP( match));
                              CASUAL_SERIALIZE( CASUAL_MAKE_NVP( result));
                           })
                        };
                        ...
                        CASUAL_CONST_CORRECT_SERIALIZE(
                        {
                           CASUAL_SERIALIZE( CASUAL_MAKE_NVP( entries));
                        })
                     };
